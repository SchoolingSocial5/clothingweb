...
export default function BannersPage() {
  ...
  if (loading) {
    return (
      <div className="px-[10px] md:px-8 py-8 w-full max-w-7xl mx-auto">
        <AdminPageHeader title="Banners Management" description="Loading banners..." />
        <div className="flex flex-col items-center justify-center py-20 animate-pulse">
          <div className="w-12 h-12 border-4 border-gray-200 border-t-black rounded-full animate-spin mb-4"></div>
          <p className="text-sm font-black uppercase tracking-widest text-gray-400">Loading your banners...</p>
        </div>
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div className="px-[10px] md:px-8 py-8 w-full max-w-7xl mx-auto">
        <AdminPageHeader title="Banners Management" description="Error loading banners." />
  ...
  return (
    <div className="px-[10px] md:px-8 py-8 w-full max-w-7xl mx-auto">
      <AdminPageHeader
        ...
        description="Configure and manage the promotional hero banners shown across client pages."
      />
      ...
      <div className="space-y-8 animate-in fade-in duration-500">
        <BannerManagement
          ...
          onDeleteRequest={(id, label) => setPendingDelete({ id, label })}
        />
      </div>
      ...
      <DeleteConfirmModal
        ...
        title="Delete Banner"
        message={`Are you sure you want to delete the banner "${pendingDelete?.label}"? This action cannot be undone.`}
      />
